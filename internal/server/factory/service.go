...
type apiInterface interface {
	BindApi(appendApi func(apis ...*base2.ApiWorker))
}
...
type installInterface interface {
	GetInstall() (info *base2.InstallInfo)
}
...
type userService interface {
	Get(userId int64) (user *base2.UserEntity, err error)
	TotalInsert(userTotal *base2.UserTotalBean) (err error)
	LoginByAccount(account string, password string) (res *base2.UserEntity, err error)
}
