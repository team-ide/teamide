...
func (service *MysqlService) InsertSqlByBean(table string, beans ...interface{}) (sqlParam base2.SqlParam) {
	params := []interface{}{}
	if len(beans) == 0 {
		return
	}

	refType := base2.GetRefType(beans[0])
	...
	for i := 0; i < fieldCount; i++ {
		...
		column := base2.GetColumnNameByType(fieldType)
		if column != "" {
	...
	for _, bean := range beans {
		refValue := base2.GetRefValue(bean) // value
		insertValues := ""
		for i := 0; i < fieldCount; i++ {
			fieldType := refType.Field(i)   // field type
			...
			value := base2.GetFieldTypeValue(fieldType.Type, fieldValue)
	...
	return base2.SqlParam{Sql: sql, Params: params}
}

func (service *MysqlService) UpdateSqlByBean(table string, keys []string, beans ...interface{}) (sqlParam base2.SqlParam) {
	params := []interface{}{}
	if len(beans) == 0 {
		return
	}
...
func (service *MysqlService) ResultToBeans(rows *sql.Rows, newBean func() interface{}) (list []interface{}, err error) {
	...
	bean := newBean()
	columnTypes := base2.GetColumnTypes(bean)

	list = []interface{}{}
	for rows.Next() {
		values := []interface{}{}
		beanColumnTypes := []base2.ColumnType{}

		for _, column := range columns {
			columnType := columnTypes[column]

			if columnType.FieldType == nil {
				beanColumnTypes = append(beanColumnTypes, base2.ColumnType{})
				continue
			}
		...
		refValue := base2.GetRefValue(bean)
...
func (service *MysqlService) Query(sqlParam base2.SqlParam, newBean func() interface{}) (list []interface{}, err error) {
	rows, err := service.db.Query(sqlParam.Sql, sqlParam.Params...)
	if err != nil {
		Logger.Error(LogStr("Query sql error , sql:", sqlParam.Sql))
		Logger.Error(LogStr("Query sql error , params:", base2.ToJSON(sqlParam.Params)))
		return
	}
...
func (service *MysqlService) QueryOne(sqlParam base2.SqlParam, newBean func() interface{}) (one interface{}, err error) {
	rows, err := service.db.Query(sqlParam.Sql, sqlParam.Params...)
	if err != nil {
		Logger.Error(LogStr("Query sql error , sql:", sqlParam.Sql))
		Logger.Error(LogStr("Query sql error , params:", base2.ToJSON(sqlParam.Params)))
...
func (service *MysqlService) Count(sqlParam base2.SqlParam) (count int64, err error) {
	rows, err := service.db.Query(sqlParam.Sql, sqlParam.Params...)
	if err != nil {
		Logger.Error(LogStr("Count sql error , sql:", sqlParam.Sql))
		Logger.Error(LogStr("Count sql error , params:", base2.ToJSON(sqlParam.Params)))
		return
	}
	if rows.Next() {
		err = rows.Scan(&count)
...
func (service *MysqlService) QueryPage(sqlParam base2.SqlParam, newBean func() interface{}) (page *base2.PageBean, err error) {
	var total int64
	total, err = service.Count(base2.SqlParam{CountSql: sqlParam.CountSql, CountParams: sqlParam.CountParams})
	if err != nil {
		return
	}
	page = &base2.PageBean{
...
func (service *MysqlService) Insert(sqlParam base2.SqlParam) (rowsAffected int64, err error) {

	result, err := service.db.Exec(sqlParam.Sql, sqlParam.Params...)
	if err != nil {
		Logger.Error(LogStr("Insert sql error , sql:", sqlParam.Sql))
		Logger.Error(LogStr("Insert sql error , params:", base2.ToJSON(sqlParam.Params)))
		return
	}
...
func (service *MysqlService) Update(sqlParam base2.SqlParam) (rowsAffected int64, err error) {
	result, err := service.db.Exec(sqlParam.Sql, sqlParam.Params...)
	if err != nil {
		Logger.Error(LogStr("Update sql error , sql:", sqlParam.Sql))
		Logger.Error(LogStr("Update sql error , params:", base2.ToJSON(sqlParam.Params)))
		return
	}
	rowsAffected, err = result.RowsAffected()
	if err != nil {
...
func (service *MysqlService) Exec(sqlParam base2.SqlParam) (rowsAffected int64, err error) {
	result, err := service.db.Exec(sqlParam.Sql, sqlParam.Params...)
	if err != nil {
		Logger.Error(LogStr("Exec sql error , sql:", sqlParam.Sql))
		Logger.Error(LogStr("Exec sql error , params:", base2.ToJSON(sqlParam.Params)))
		return
	}
	rowsAffected, err = result.RowsAffected()
	if err != nil {
...
func (service *MysqlService) Delete(sqlParam base2.SqlParam) (rowsAffected int64, err error) {
	result, err := service.db.Exec(sqlParam.Sql, sqlParam.Params...)
	if err != nil {
		Logger.Error(LogStr("Delete sql error , sql:", sqlParam.Sql))
		Logger.Error(LogStr("Delete sql error , params:", base2.ToJSON(sqlParam.Params)))
		return
	}
	rowsAffected, err = result.RowsAffected()
	if err != nil {
...
func (service *MysqlService) AppendWhere(one interface{}, sqlParam *base2.SqlParam) {
