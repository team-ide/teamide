...
func (this_ *api) GetApis() (apis []*base.ApiWorker) {
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager"}, Power: Power, Do: this_.index})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/create"}, Power: createPower, Do: this_.create})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/file"}, Power: filePower, Do: this_.file})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/files"}, Power: filesPower, Do: this_.files})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/read"}, Power: readPower, Do: this_.read})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/write"}, Power: writePower, Do: this_.write})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/rename"}, Power: renamePower, Do: this_.rename})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/remove"}, Power: removePower, Do: this_.remove})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/move"}, Power: copyPower, Do: this_.move})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/copy"}, Power: movePower, Do: this_.copy})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/upload"}, Power: uploadPower, Do: this_.upload, IsUpload: true})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/download"}, Power: downloadPower, Do: this_.download, IsGet: true})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/callAction"}, Power: callActionPower, Do: this_.callAction})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/callStop"}, Power: callStopPower, Do: this_.callStop})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/close"}, Power: closePower, Do: this_.close})
	apis = append(apis, &base.ApiWorker{Apis: []string{"fileManager/open"}, Power: openPower, Do: this_.open, IsGet: true})
	return
}
