	...
	worker_ := &ToolboxType{
		...
		ConfigForm: &form.Form{
			Fields: []*form.Field{
				...
				{Label: "Username", Name: "username", VIf: `type != 'sqlite' && type != 'odbc' && type != 'gbase'`, Col: 6},
				{Label: "Password", Name: "password", Type: "password", VIf: `type != 'sqlite' && type != 'odbc' && type != 'gbase'`, Col: 6, ShowPlaintextBtn: true},
	...
	worker_ := &ToolboxType{
		...
		ConfigForm: &form.Form{
			Fields: []*form.Field{
				...
				{Label: "用户名", Name: "username", Col: 6},
				{Label: "密码", Name: "password", Col: 6, ShowPlaintextBtn: true},
	...
	worker_ := &ToolboxType{
		...
		ConfigForm: &form.Form{
			Fields: []*form.Field{
				...
				{Label: "Username", Name: "username", Col: 6},
				{Label: "Password", Name: "password", Type: "password", Col: 6, ShowPlaintextBtn: true},
	...
	worker_ := &ToolboxType{
		...
		ConfigForm: &form.Form{
			Fields: []*form.Field{
				...
				{Label: "用户名", Name: "username", Col: 6},
				{Label: "密码", Name: "auth", Type: "password", Col: 6, ShowPlaintextBtn: true},
				{Label: "Cert", Name: "certPath", Type: "file", Placeholder: "请上传Cert"},
			},
		},
	}
