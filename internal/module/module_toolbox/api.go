...
var (
	...
	PowerToolboxDatabaseDownload    = base.AppendPower(&base.PowerAction{Action: "toolbox_database_download", Text: "数据库下载", Parent: PowerToolboxPage, ShouldLogin: true, StandAlone: true})
...
func (this_ *ToolboxApi) GetApis() (apis []*base.ApiWorker) {
	...
	apis = append(apis, &base.ApiWorker{Apis: []string{"toolbox/database/download"}, Power: PowerToolboxDatabaseDownload, Do: this_.databaseDownload, IsGet: true})
