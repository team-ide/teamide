...
func (this_ *NodeApi) GetApis() (apis []*base.ApiWorker) {
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/context"}, Power: contextPower, Do: this_.context})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/list"}, Power: listPower, Do: this_.list})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/start"}, Power: startPower, Do: this_.start})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/stop"}, Power: stopPower, Do: this_.stop})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/insert"}, Power: insertPower, Do: this_.insert})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/update"}, Power: updatePower, Do: this_.update})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/updateOption"}, Power: updateOptionPower, Do: this_.updateOption})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/enable"}, Power: enablePower, Do: this_.enable})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/disable"}, Power: disablePower, Do: this_.disable})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/delete"}, Power: deletePower, Do: this_.delete})

	apis = append(apis, &base.ApiWorker{Apis: []string{"node/system/info"}, Power: systemInfoPower, Do: this_.nodeSystemInfo})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/system/queryMonitorData"}, Power: systemMonitorDataPower, Do: this_.nodeSystemQueryMonitorData})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/system/cleanMonitorData"}, Power: systemCleanMonitorDataPower, Do: this_.nodeSystemCleanMonitorData})

	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/list"}, Power: netProxyListPower, Do: this_.netProxyList})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/insert"}, Power: netProxyInsertPower, Do: this_.netProxyInsert})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/update"}, Power: netProxyUpdatePower, Do: this_.netProxyUpdate})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/updateOption"}, Power: netProxyUpdateOptionPower, Do: this_.netProxyUpdateOption})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/monitorData"}, Power: netProxyMonitorDataPower, Do: this_.netProxyMonitorData})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/enable"}, Power: netProxyEnablePower, Do: this_.netProxyEnable})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/disable"}, Power: netProxyDisablePower, Do: this_.netProxyDisable})
	apis = append(apis, &base.ApiWorker{Apis: []string{"node/netProxy/delete"}, Power: netProxyDeletePower, Do: this_.netProxyDelete})
