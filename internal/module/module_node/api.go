...
var (
	...
	PowerNodeContext      = base.AppendPower(&base.PowerAction{Action: "node_context", Text: "节点上下文", Parent: PowerNode, ShouldLogin: true, StandAlone: true})
	...
	PowerNodeUpdateOption = base.AppendPower(&base.PowerAction{Action: "node_update_option", Text: "节点修改配置", Parent: PowerNode, ShouldLogin: true, StandAlone: true})
	PowerNodeEnable       = base.AppendPower(&base.PowerAction{Action: "node_enable", Text: "节点启用", Parent: PowerNode, ShouldLogin: true, StandAlone: true})
	PowerNodeDisable      = base.AppendPower(&base.PowerAction{Action: "node_disable", Text: "节点停用", Parent: PowerNode, ShouldLogin: true, StandAlone: true})
	...
	PowerNetProxy             = base.AppendPower(&base.PowerAction{Action: "node_net_proxy", Text: "节点代理", Parent: PowerNode, ShouldLogin: true, StandAlone: true})
	PowerNetProxyList         = base.AppendPower(&base.PowerAction{Action: "node_net_proxy_list", Text: "节点代理列表", Parent: PowerNetProxy, ShouldLogin: true, StandAlone: true})
