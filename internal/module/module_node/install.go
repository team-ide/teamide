...
CREATE TABLE ` + TableNode + ` (
	...
	address varchar(50) DEFAULT NULL COMMENT '说明',
	token varchar(50) DEFAULT NULL COMMENT '说明',
	connAddress varchar(100) DEFAULT NULL COMMENT '连接节点地址',
	connToken varchar(50) DEFAULT NULL COMMENT '连接节点Token',
	parentServerId varchar(50) DEFAULT NULL COMMENT '父级节点服务ID',
...
CREATE TABLE ` + TableNode + ` (
	...
	parentServerId varchar(50) DEFAULT NULL,
