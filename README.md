...
[![Release Latest](https://img.shields.io/badge/Release-V1.5.7-brightgreen)](https://github.com/team-ide/teamide/releases)
...
> #### Team IDE 单机运行方式： 无需配置文件，数据和日志存储在`用户目录/TeamIDE`下
