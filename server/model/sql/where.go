...
var (
	...
	LIKE_AFTER      = appendOperator("LIKE%", "开始以")
	NOT_LIKE_AFTER  = appendOperator("NOT LIKE%", "开始不是以")
	LIKE_BEFORE     = appendOperator("%LIKE", "结束以")
	NOT_LIKE_BEFORE = appendOperator("NOT %LIKE", "结束不是以")
