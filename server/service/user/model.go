...
func (this_ *UserService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *UserService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *UserService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *UserService) GetDeleteSqls() []*sqlModel.Delete {
