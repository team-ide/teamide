...
var (
	sqlUserJobPage = newSelectSql(&sqlModel.Select{
		Table: TABLE_JOB,
	...
	sqlUserJobList = newSelectSql(&sqlModel.Select{
		Table: TABLE_JOB,
		Columns: []*sqlModel.SelectColumn{
			{Name: "userId"},
			{Name: "name"},
	...
	sqlUserJobOne = newSelectSql(&sqlModel.Select{
		Table: TABLE_JOB,
		Columns: []*sqlModel.SelectColumn{
			{Name: "userId"},
			{Name: "name"},
	...
	sqlUserJobInsert = newInsertSql(&sqlModel.Insert{
		Table: TABLE_JOB,
	...
	sqlUserJobUpdate = newUpdateSql(&sqlModel.Update{
		Table: TABLE_JOB,
	...
	sqlUserJobDelete = newDeleteSql(&sqlModel.Delete{
		Table: TABLE_JOB,
		Wheres: []*sqlModel.Where{
			{Name: "userId", Required: true},
		},
