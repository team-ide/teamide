...
func (this_ *JobService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *JobService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *JobService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *JobService) GetDeleteSqls() []*sqlModel.Delete {
