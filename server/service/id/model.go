...
func (this_ *IdService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *IdService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *IdService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *IdService) GetDeleteSqls() []*sqlModel.Delete {
