...
func (this_ *CertificateService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *CertificateService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *CertificateService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *CertificateService) GetDeleteSqls() []*sqlModel.Delete {
