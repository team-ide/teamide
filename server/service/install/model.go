...
func (this_ *InstallService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *InstallService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *InstallService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *InstallService) GetDeleteSqls() []*sqlModel.Delete {
