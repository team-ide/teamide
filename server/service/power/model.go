...
func (this_ *PowerService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *PowerService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *PowerService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *PowerService) GetDeleteSqls() []*sqlModel.Delete {
