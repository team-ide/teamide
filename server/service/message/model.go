...
func (this_ *MessageService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *MessageService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *MessageService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *MessageService) GetDeleteSqls() []*sqlModel.Delete {
