...
func (this_ *WbsService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *WbsService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *WbsService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *WbsService) GetDeleteSqls() []*sqlModel.Delete {
