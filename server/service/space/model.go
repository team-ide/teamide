...
func (this_ *SpaceService) GetSelectSqls() []*sqlModel.Select {

	return selectSqlModels
}

func (this_ *SpaceService) GetInsertSqls() []*sqlModel.Insert {

	return insertSqlModels
}

func (this_ *SpaceService) GetUpdateSqls() []*sqlModel.Update {

	return updateSqlModels
}

func (this_ *SpaceService) GetDeleteSqls() []*sqlModel.Delete {
