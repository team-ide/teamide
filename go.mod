...
replace (
	github.com/godror/godror latest => github.com/team-ide/godror latest
)
...
require (
	...
	github.com/team-ide/go-dialect v1.0.3 // indirect
	github.com/team-ide/go-driver v1.1.0 // indirect
