...
export default {
  ...
  methods: {
    show(data, callback) {
      ...
      this.formBuild = this.form.build(this.form.toolboxOption.kafka.topic);
  ...
  mounted() {
    this.toolboxWorker.showTopicForm = this.show;
    this.toolboxWorker.hideTopicForm = this.hide;
    this.init();
  },
};
</script>
