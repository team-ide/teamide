...
// guaranteed to be the empty string (""). TunnelPipe implementations may use
...
// TunnelPipe provides a unique identifier and synchronized access to the InstructionReader and Writer
...
// Base TunnelPipe implementation which synchronizes access to the underlying reader and writer with locks
