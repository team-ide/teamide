...
func NewInvoker(app *model.Application) (runner *Invoker) {
	runner = &Invoker{
		app: app,
	}
	return
...
func (this_ *Invoker) InvokeService(service *model.ServiceModel, invokeData *InvokeData) (res interface{}, err error) {
	defer func() {
		if e := recover(); e != nil {
...
func (this_ *Invoker) invokeStep(step *model.StepModel, invokeData *InvokeData) (ok bool, err error) {
	ok = true
	return
}
